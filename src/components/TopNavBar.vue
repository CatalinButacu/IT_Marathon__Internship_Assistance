  ...
  >
    <div class="container inner-nav">
      <div class="logo-menu-container">
        <div class="logo-container" style="margin-right:60px;margin-">
          <img src="@/assets/logo.svg" alt="svg" /><i>Internship Assistance</i>
        </div>
      ...
      <div class="nav-items-container" :class="{ shower: mobileNav }">
        <ul class="left-nav-list">
          <li @click="mobileNav = false">
            <router-link to="/" class="nav-item color-white">Feed</router-link>
          </li>
          <li @click="mobileNav = false">
